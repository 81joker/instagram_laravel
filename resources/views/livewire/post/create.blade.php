<div class="  bg-white lg:h-[500px] flex flex-col border gap-y-4  px-5">
    ...
    <main class="grid lg:grid-cols-12 gap-3 h-full w-full overflow-hidden ">
        ...
        <aside class=" lg:col-span-7  m-auto items-center w-full overflow-scroll  ">
            ...
            {{-- upload media -will be hidden if files count <0 --}} <label for="customFileInput" class="m-auto max-w-fit   flex-col  flex  gap-3 cursor-pointer">
                <input type="file" wire:model="photo" multiple accept=".jpg,.png,.jpeg" class="sr-only" id="customFileInput">
            ...
            <div class="  hidden overflow-x-scroll w-[500px] h-96 snap-x snap-mandatory gap-2 px-2 ">
                ...
                <div class=" w-full h-full snap-always  shrink-0 snap-center">
                    <img class="w-full h-full  object-contain" src="https://plus.unsplash.com/premium_photo-1666900440561-94dcb6865554?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8cmFuZG9tfGVufDB8fDB8fHww&auto=format&fit=crop&w=800&q=60" />
        ...
        <aside class="lg:col-span-5 h-full border-l p-3 flex gap-4 flex-col overflow-hidden overflow-y-scroll">
            ...
            <div>
                <textarea placeholder="Add a caption." class="  border-0 focus:border-0 px-0  w-full  rounded-lg    bg-white  h-32 focus:outline-none  focus:ring-0  "></textarea>
            ...
            <div class="flex gird grid-cols-12 items-center">
                <input placeholder="Add Location" type="text" class=" border-0 focus:border-0 px-0  w-full placeholder:font-normal  rounded-lg    bg-white   focus:outline-none  focus:ring-0 ">
            </div>

            <section class="" x-data="{ open: false }">
                <button @click="open =! open" @class([ 'flex cursor-pointer w-full  rounded-lg hover:bg-gray-50  p-2  -ml-2  justify-between items-center text-gray-700 dark:text-gray-300' , ]) class="">
                    {{-- Selected --}}
